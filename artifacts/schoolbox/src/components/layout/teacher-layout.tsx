...
import { LogOut, LayoutDashboard, ClipboardCheck, AlertTriangle, Users, BookOpen, GraduationCap, Menu, X } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-100">
      ...
      <div className="md:hidden flex items-center justify-between px-4 py-3 text-white"
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-sm">SchoolBox Teacher</span>
        </div>
      ...
      <div className={`${isMobileMenuOpen ? "block" : "hidden"} md:flex md:flex-col w-full md:w-60 flex-shrink-0`}
        ...
        <div className="hidden md:flex items-center gap-3 px-5 py-6 border-b border-white/10">
          ...
          <div>
            ...
            <p className="text-green-300 text-xs">Teacher Portal</p>
          </div>
        </div>
        ...
        <div className="p-3 border-t border-white/10">
          <div className="flex items-center gap-3 px-2 py-2 mb-1">
            ...
            <div className="min-w-0">
              ...
              <p className="text-green-300 text-xs">Teacher</p>
            </div>
          </div>
