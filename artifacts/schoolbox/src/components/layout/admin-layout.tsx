...
import {
  LogOut, LayoutDashboard, Users, GraduationCap,
  BarChart2, Bell, Menu, X, BookOpen, ChevronRight,
} from "lucide-react";
      ...
      >
                ...
                return (
                  <Link key={item.name} href={item.href}>
                    <div
                      ...
                      onMouseEnter={e => {
                        if (!active) (e.currentTarget as HTMLDivElement).style.backgroundColor = SIDEBAR_HOVER_BG;
                      }}
                      onMouseLeave={e => {
                    ...
                    >
                      ...
                      {active && (
                        <ChevronRight style={{ width: "12px", height: "12px", color: "#4d7a62", flexShrink: 0 }} />
                      )}
                    </div>
                  </Link>
                );
        ...
        <div style={{ padding: "12px", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
          ...
          <button
            ...
            onMouseEnter={e => {
              (e.currentTarget as HTMLButtonElement).style.backgroundColor = SIDEBAR_HOVER_BG;
              (e.currentTarget as HTMLButtonElement).style.color = "#7da890";
            }}
            onMouseLeave={e => {
              (e.currentTarget as HTMLButtonElement).style.backgroundColor = "transparent";
              (e.currentTarget as HTMLButtonElement).style.color = "#4d7a62";
            }}
          >
